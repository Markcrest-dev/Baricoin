...
let TradeController = class TradeController {
    ...
    async submitGiftCard(req, body, file) {
        return this.tradeService.submitGiftCard(req.user.userId, body, file);
    }
    async initiateCryptoTrade(req, body) {
...
], TradeController.prototype, "getRates", null);
__decorate([
    (0, common_1.Post)('giftcards'),
    ...
    __metadata("design:returntype", Promise)
], TradeController.prototype, "submitGiftCard", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TradeController.prototype, "initiateCryptoTrade", null);
